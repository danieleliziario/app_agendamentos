	...
	<head>
		...
		<script>
			function editar(id, data_inicial, data_final, descricao, titulo, cliente){
				...
				let teste = `<form method="post" action="agenda_controller.php?pag=pen&acao=atualizar">
			...
			function remover(){
				location.href = 'index.php?pag=pen&acao=remover&id='+testeid;
			}

			function marcarRealizada(id){
				location.href = 'index.php?pag=pen&acao=marcarRealizada&id='+id;
			}
		</script>
	</head>
		...
		<div class="container app">
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						<li class="list-group-item active"><a href="#">Agendamentos pendentes</a></li>
